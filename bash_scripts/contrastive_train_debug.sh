#!/bin/bash
#SBATCH --job-name=selex_debug_aircraft
...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/SelEx/air_debug_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/SelEx/air_debug_%j.err
